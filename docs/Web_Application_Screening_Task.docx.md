...
| Sample Data | [sample\_equipment\_data.csv](https://drive.google.com/file/d/1cq26Jb7vQ8RC1POISdGic0jr_tuTJI1E/view?usp=drive_link) | Sample CSV file provided for testing & demo |
...
6. **(Extra)** Use the provided sample CSV ([sample\_equipment\_data.csv](https://drive.google.com/file/d/1cq26Jb7vQ8RC1POISdGic0jr_tuTJI1E/view?usp=drive_link)) for demo and testing.
